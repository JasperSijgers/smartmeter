...
$sql = "(SELECT timestamp, verbr_laag, verbr_hoog, terug_laag, terug_hoog FROM `data` WHERE (`timestamp` < '$previous_hour:59:59') ORDER BY `timestamp` DESC LIMIT 1) 
UNION (SELECT timestamp, verbr_laag, verbr_hoog, terug_laag, terug_hoog FROM `data` WHERE (`timestamp` BETWEEN '$current_date:00:00' AND '$current_date:00:59')";
