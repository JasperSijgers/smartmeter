...
$sql = "SELECT timestamp, verbr_laag, verbr_hoog FROM `data` WHERE (`timestamp` BETWEEN '$last_day 23:59:00' AND '$last_day 23:59:59')";

$months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
for($i = 1; $i < date('m'); $i++){
    $date = date('Y-m-d', strtotime('last day of ' . $months[$i]));
